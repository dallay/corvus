...
- [ ] Keep dashboard handoff copy aligned with the shared onboarding spec when local entrypoints change.
...
- [ ] Keep session recovery distinct from onboarding recovery when adding richer chat transport features.
