...
- [ ] 1.1 Capture current onboarding output/order baseline for decline-parity protection.
  - Depends on: none
...
- [ ] 1.2 Add dashboard activation domain test scaffolding (decision, diagnosis, rendering).
  - Depends on: 1.1
...
- [ ] 1.3 Add security-output guard tests for onboarding activation messaging.
  - Depends on: 1.2
...
- [ ] 2.1 Insert final optional prompt in onboarding at the designed insertion point.
  - Depends on: 1.4
  - Covers: RF1, AC1
...
- [ ] 2.2 Implement decline branch as no-mutation, CLI-only parity path.
  - Depends on: 2.1
  - Covers: RF3, NFR-C1, AC3
...
- [ ] 2.3 Render concise resume-later block for decline path.
  - Depends on: 2.2
  - Covers: RF5, AC5
...
- [ ] 3.1 Implement one-screen 3-5 step accept-path activation guide.
  - Depends on: 2.4
...
- [ ] 3.2 Add optional browser-open attempt targeting dashboard URL with non-fatal fallback.
  - Depends on: 3.1
...
- [ ] 3.3 Ensure accept path always includes resume-later block.
  - Depends on: 3.1
  - Covers: RF5, AC5
...
- [ ] 4.1 Implement bounded local diagnosis probes and deterministic state mapping.
  - Depends on: 3.4
...
- [ ] 4.2 Emit stable DASH status codes and concise cause line.
  - Depends on: 4.1
...
- [ ] 4.3 Implement state-specific fallback command blocks (secure-only guidance).
  - Depends on: 4.2
...
- [ ] 4.4 Enforce security invariants in activation output path.
  - Depends on: 4.3
  - Covers: NFR-S1, AC6
...
- [ ] 5.1 Update onboarding docs with final prompt, accept/decline behavior, and canonical URLs.
  - Depends on: 4.5
...
- [ ] 5.2 Update dashboard activation troubleshooting and resume-later guidance.
  - Depends on: 5.1
...
- [ ] 6.1 Execute targeted test stack for onboarding activation.
  - Depends on: 5.3
  - Covers: AC1-AC7
...
- [ ] 6.2 Run broader regression gate for touched surfaces.
  - Depends on: 6.1
...
- [ ] 6.3 Traceability and artifact closure gate.
  - Depends on: 6.1, 6.2
