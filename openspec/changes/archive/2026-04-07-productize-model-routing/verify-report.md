...
The change now satisfies the Phase 1 scope, passes formatter/clippy/test/docs checks relevant to the
touched areas, and has runtime evidence for all spec scenarios.
