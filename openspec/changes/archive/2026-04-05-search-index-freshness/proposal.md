...
This change delivers the minimal safe v1 so agent-authored file writes become searchable immediately,
...
index location, rollback is limited to code reversion; if needed, deleting `state/code-search/index.db`
