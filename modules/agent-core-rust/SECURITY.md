...
2. **GitHub**: Use [GitHub Security Advisories](https://github.com/dallay/corvus/security/advisories/new)
...
Corvus implements defense-in-depth security:
...
Corvus Docker images follow CIS Docker Benchmark best practices:
...
docker inspect --format='{{.Config.User}}' corvus
# Expected: 65534:65534

# Run with read-only filesystem (production hardening)
docker run --read-only -v /path/to/workspace:/workspace corvus gateway
```
