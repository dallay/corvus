# Corvus ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for Corvus edge scenarios on ESP32.
...
3. Connect UI state with Corvus edge/runtime messaging
