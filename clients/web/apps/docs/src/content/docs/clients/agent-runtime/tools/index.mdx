...
- [**Core Tools**](core.md) — System command execution (`shell`), native workspace search (`code_search`), and workspace filesystem access (`file_read`, `file_write`).
...
- *Examples:* `file_read`, `memory_recall`, `web_search_tool`, `image_info`, `hardware_board_info`.
