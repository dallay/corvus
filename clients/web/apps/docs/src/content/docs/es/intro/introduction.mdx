...
- **Lógica Core**: [Kotlin Multiplatform (KMP)](https://kotlinlang.org/docs/multiplatform.html)
...
- **Web Stack**: [Astro](https://astro.build/), [Vue 3](https://vuejs.org/) y [Tailwind CSS](https://tailwindcss.com/docs)
