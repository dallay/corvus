...
Si Cerebro no está configurado o no es accesible, las llamadas a herramientas heredadas devuelven un error estructurado y no se intenta ninguna alternativa con SurrealDB.
